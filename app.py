...
Олег С: Леша Ч                          ← пара (не должны быть вместе)
Аня К: Петя О, Маша И, Саша В           ← несколько человек (Аня отдельно от всех троих)
Иван Д: Ольга М                         ← ещё одна пара
Дмитрий К: Елена В, Наталья С, Юрий Т   ← один человек не должен быть с тремя другими""",
        height=240
    )
